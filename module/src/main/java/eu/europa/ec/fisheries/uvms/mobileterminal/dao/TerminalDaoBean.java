...
public class TerminalDaoBean {
    ...
    private AuditQuery createAuditQuery(List<MTSearchKeyValue> searchFields, boolean isDynamic, boolean includeArchived) {
        ...
        AuditAssociationQuery aaQuery = null;
        initializeAuditAssociationQuery(aaQuery, auditReader, searchFields, includeArchived);
    ...
    private void initializeAuditAssociationQuery(AuditAssociationQuery aaQuery, AuditReader auditReader, List<MTSearchKeyValue> searchFields, boolean includeArchived) {
