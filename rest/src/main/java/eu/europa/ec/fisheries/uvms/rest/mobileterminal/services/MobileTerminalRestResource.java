...
public class MobileTerminalRestResource {
    ...
    @Path("/history/{id}")
    @RequiresFeature(UnionVMSFeature.viewVesselsAndMobileTerminals)
    public MTResponseDto<List<MobileTerminal>> getMobileTerminalHistoryListByMobileTerminalId(@PathParam("id") String id) {
        ...
        try {
            ...
            return new MTResponseDto<>(mobileTerminalRevisions, MTResponseCode.OK);
        } catch (Exception ex) {
