...
//    @EJB(lookup = ServiceConstants.DB_ACCESS_CONFIG_MODEL)
    ...
    public void processUpdatedDNIDList(String pluginName) {
            ...
            } catch (MobileTerminalServiceException | ModelMarshallException e) {
    ...
    private void sendUpdatedDNIDListToConfig(String settingKey, String settingValue) throws ModelMarshallException, MobileTerminalServiceException {
    ...
    private void sendUpdatedDNIDListToExchange(String pluginName, String settingKey, String settingValue) {
        ...
        } catch (ExchangeModelMarshallException | MobileTerminalServiceException e) {
