 ...
 */
@Entity
@Table(name = "inmarsatc_oceanregion", indexes = { @Index(columnList = "id", name = "inmarsatc_oceanregion00", unique = true),
		@Index(columnList = "inmarsatc_history_id", name = "inmarsatc_oceanregion10", unique = false),})
